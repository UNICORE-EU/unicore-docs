...
`OpenJDK <http://www.oracle.com/technetwork/java/javase/downloads/index.html>`_.
...
see `dyn-reg`_ for details. Then this file should contain only the 
...
.. include:: sec-ref-credProperties.rest
    

.. include:: sec-ref-trustProperties.rest
...
advanced HTTP server parameters. See `ref-jetty`_ for details. 
...
.. include:: gw-ref-main.rest

.. _ref-jetty:

.. include:: sec-ref-jettyProperties.rest
...
The `Using the Gateway for failover and/or loadbalancing of UNICORE sites`_ covered usage of the Gateway to provide failover of backend services.
